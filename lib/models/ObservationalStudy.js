...
const ObservationalStudy = Base.discriminator('ObservationalStudy', new mongoose.Schema({
  publicSummary: {  
    tag: {
      type: String,
      default: '2.0P',
  ...
  cancerType: {  
    ...
    tagHeader: {
      type: String,
      default: '3.3 Cancer types, condition types',
      required: true 
    },
    entry: String
  },
  staging: {  
    ...
    tagHeader: {
      type: String,
      default: '3.4 Staging of study participants if reported',
      required: true 
    },
    entry: String
  },
  ...
  adverseEventsDesc: {  
    ...
    tagHeader: {
      type: String,
      default: '7.1 Adverse events associated with intervention described',
      required: true 
    },
    entry: String
  },
...
module.exports = mongoose.model('ObservationalStudy', ObservationalStudy.schema);
